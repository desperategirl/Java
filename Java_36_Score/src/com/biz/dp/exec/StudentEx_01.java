...
public class StudentEx_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 자바 빈즈패턴(Java Beans Patter, 자바의 고전적인 코딩)
		 */
		...
		// 생성자를 이용해서 필드값을 초기화하면서 객체를 생성하고 
		...
		// 별도의 변수객체를 만들지 않고 
		// add() method에 직접 생성자 코드를 작성해서 List에 추가
		...
		// 생성자를 이용하는 객체생성
		// 1. 생성자의 매개변수를 순서대로 정확히 인식해야만
		// 		오류가 없는 값을 추가할 수 있다.
		// 2. 지금 당장 추가하지 않아도 될 필드값도
		// 		의무적으로 모두 추가해야 하는 단점이 있다.
